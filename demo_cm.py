...
# Define data as age and income
data = [{
    'name':'age', 'reps': [25, 30, 35]},
    {'name': 'income', 'reps': [50000, 60000, 70000]
}]
# Use the define_dataframe_structure function to create a seed data frame
...
# Use the simulate_data function to generate new data based on the seed data frame
# Should generate 10 points per group
